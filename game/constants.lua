...
constants.IMAGES_CURSOR_HAND_CLICKED       = love.graphics.newImage("assets/images/cursor_hover.png")
constants.IMAGES_CURSOR_HAND               = love.graphics.newImage("assets/images/cursor_hover.png")
